...
class lane_drive():
    ...
    def __init__(self):
        ...
        rospy.init_publisher('/ctrl_cmd', CtrlCmd, queue_size=1)
        cmd = CtrlCmd()
        cmd.longlCmdType = 2
        cmd.velocity = self.speed
        steering_cmd = [ -self.angle, self.angle]
    ...
    def callback(self, msg):
        ...
        img_ready = True
        self.angle,self.speed = self.lane_drive(image)
