...
class pure_pursuit :
    def __init__(self):
        ...
        rospy.Subscriber("/Speed", Vector3, self.speed_callback)
        ...
        while not rospy.is_shutdown():
            ...
            if self.is_global_path == True and self.is_odom == True :#and self.is_status == True:
                ...
                output = self.pid.pid(self.target_velocity,self.speed_x*3.6)

                if output > 0.0:
                    self.ctrl_cmd_msg.velocity = output
    ...
    def calc_pure_pursuit(self,):
        ...
        self.lfd = (self.speed_x) * self.lfd_gain
