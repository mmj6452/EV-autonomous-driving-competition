...
class morai_gt_parser:
    def __init__(self):
        ...
        rospy.Subscriber("/imu", Imu, self.status_callback)
    ...
    def status_callback(self,msg): ## Vehicl Status Subscriber 
        ...
        br.sendTransform((self.map_x, self.map_y, 0),
                        tf.transformations.quaternion_from_euler(0, 0, self.yaw_deg/180*pi),
                        rospy.Time.now(),
                        "gps",
                        "map")
        ...
        q_x,q_y,q_z,q_w = quaternion_from_euler(0, 0, self.yaw_deg/180*pi)
